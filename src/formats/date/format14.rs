...
mod tests {
    ...
    fn test_format14_parse() {
        let fmt = Format14;
        assert!(fmt.parse("03/24/2023*", "", 1).is_some());
        assert!(fmt.parse("3/24/2023*", "", 1).is_some());
        assert!(fmt.parse("03/24/23*", "", 1).is_some());
        assert!(fmt.parse("3/24/23*", "", 1).is_some());
        assert!(fmt.parse("1/1/2023*", "", 1).is_some());
        assert!(fmt.parse("02/30/2023*", "", 1).is_none());
